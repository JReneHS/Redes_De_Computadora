/*#######################################################################################
Alumno: Sanchez Sosa Edith Kathya
Practica # 3    Analizador LLC.
Redes
...
void analizador(unsigned char *trama) {
	printf("\n\n    **ETHERNET**\n");
	printf(" MDestino: %02x:%02x:%02x:%02x:%02x:%02x\n    MOrigen:  %02x:%02x:%02x:%02x:%02x:%02x\n",
...
void main()
{
	...
	printf("\n\n    Practica_2_Analizador_LLC\n");
	printf("\n\n    Sanchez Sosa Edith Kathya\n");
	char i;
	for(i = 0; i < 35; i++) {
		printf("\n    Trama %i", i+1);
		analizador(trama[i]);
